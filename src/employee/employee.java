...
public class employee implements Comparable<employee> {
    ...
    public int compareTo(employee other) {
        if(this.sells < other.getSells()) return -1;
        else if(this.sells > other.getSells()) return 1;
        return 0;
    }

    @Override
    public String toString() {
        return this.f_name + " " + this.ID + " " + this.sells + " " + calculate_Salary();
    }
}
